    ...
    if (validTypeValues.includes(destinationType)) {
      switch (destinationType) {
        case "object":
          ...
          if (
            destinationAction &&
            validActionValues.includes(destinationAction.toLowerCase())
          ) {
            if (destinationName) {
              ...
              throw new Error(
                "Missing Destination Name. Since you have Destination Type set to Object, the Destination Name should be something like Account or MyObj__c"
              );
            }
          } else {
            throw new Error(
              "Unsupported or missing Destination Action. Currently this component supports home, list, and new"
            );
          }
        ...
        case "record":
          ...
          if (destinationRecordId) {
            ...
            throw new Error(
              "Missing RecordId. Since you have DestinationType set to record, you need to pass in a RecordId. If you want to create a new record, use a DestinationType of object instead and a DestinationAction of new"
            );
          }
          break;
        ...
        case "url":
          if (destinationUrl) {
            ...
            throw new Error(
              "Missing DestinationUrl. Since you have DestinationType set to url, you need to pass in a valid URL"
            );
          }
          break;
        ...
        case "tab":
          if (destinationName) {
            ...
            throw new Error(
              "Missing DestinationName. Since you have DestinationType set to tab, you need to pass in a valid name. Here, that needs to be the unique name of a CustomTab"
            );
          }
          break;
        ...
        case "knowledge":
          if (destinationUrl) {
            ...
            throw new Error(
              "Missing DestinationUrl. Since you have DestinationType set to knowledge, you need to pass in a valid Url, representing the urlName field on the target KnowledgeArticleVersion record."
            );
          }
          break;
        case "relatedlist":
          ...
          if (
            ...
            throw new Error(
              "Missing required data. Since you have DestinationType set to relationshiplist, you need to pass in 1) a RecordId 2) a DestinationName like Case, 3) a RelationshipName like CaseComments and 4) a DestinationAction (which here has to be view) "
            );
          }
          break;
        ...
        default:
          throw new Error(
            "The code should definitely not have reached this point. Bad human."
          );
      }
    } else {
      throw new Error(
        "Unsupported or missing destination Type. Currently this component supports object, record, url, namedpage, tab, knowledge, relatedlist, and app"
      );
    }
