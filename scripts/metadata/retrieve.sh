...
## check status
## sfdx force:mdapi:deploy:report --jobid=0Af5E00001BOdTqSAL

## Deploy and skip validation using quick deploy with job ID returned in the previous step
##sfdx force:mdapi:deploy --targetusername aa-release --validateddeployrequestid=0Af5E00001BOdTqSAL --wait=-1
