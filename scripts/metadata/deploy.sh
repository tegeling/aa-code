...
sfdx force:mdapi:deploy --targetusername aa-production --checkonly --zipfile releases/Winter21v10.zip --testlevel RunLocalTests --wait=-1
...
sfdx force:mdapi:deploy --targetusername aa-production --validateddeployrequestid=0Af0800001SaraJCAR --wait=-1
