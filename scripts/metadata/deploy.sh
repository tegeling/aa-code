...
sfdx force:mdapi:deploy --targetusername aa-production --checkonly --zipfile releases/Summer20v2.zip --testlevel RunLocalTests --wait=-1
...
sfdx force:mdapi:deploy --targetusername aa-production --validateddeployrequestid=0Af1p00001RXaMPCA1 --wait=-1
