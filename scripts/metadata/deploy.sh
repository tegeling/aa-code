...
sfdx force:mdapi:deploy --targetusername aa-production --checkonly --zipfile releases/Summer20v1.zip --testlevel RunLocalTests --wait=-1
...
sfdx force:mdapi:deploy --targetusername aa-production --validateddeployrequestid=0Af1p00001RXCC6CAP --wait=-1
